...
We could envision such a system to have input information characterized as a set of symbols representing each state representing input information. Each symbol being unique in a set per signal. We could concieve of this looking something like a set of characters:
...
While so many responses to the knowledge argument have been good, I have felt they were always lacking the key point which I have presented here. Specifically, the constraint which we inherently have given the method of communication we use.
