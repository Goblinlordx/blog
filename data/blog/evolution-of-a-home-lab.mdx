...
date: '2026-01-25'
tags: ['home-lab', 'raspberry-pi', 'cluster', 'home-lab-history', 'kodi', 'jellyfin', 'audiobookshelf']
draft: false
layout: PostBanner
...
In 2018, the landscape was different. I was operating with a minimalist mindset, prioritizing low power and low cost above all else. The heart of my operation was a Raspberry Pi 3. There was an additional update around 2019 to upgrade to a Raspberry Pi 4b.

### The Hardware Constraints
The setup was as "lean" as it gets. I had the Pi 4b paired with an 8TB WD Elements USB drive. At the time, 8TB felt like an ocean of space, but the hardware limitations of the Pi 4b were significant.
...
This wasn't just about raw CPU clock speed; it was about Intel QuickSync. This dedicated hardware core provided robust, hardware-accelerated encoding and decoding for H.264 and H.265 (HEVC). In the world of high-quality cat videos, being able to transcode on the fly without pegging the CPU to 100% was the "killer feature" I had been missing. To support this new horsepower, I added a 14TB WD Elements drive to the stack, bringing my total capacity to 22TB.
...
The most persistent challenge of the current state is the lack of a unified storage layer. Because the archive is spread across four distinct external USB volumes—the legacy 8TB, the Phase 2 14TB, and the two new 26TB Seagate Expansion drives—there is no cohesive "pool."
